...
<body>
			...
			<div class="out">
				<div class="in">
					<div>
									...
									<td id="board_del">
										<div class="dropdown">
											...
											<div class="dropdown-content del_drop">
												<a href="${ContextPath }/admin/board/reviewBoardList?del=0&num=1">게시중</a> <a
													href="${ContextPath }/admin/board/reviewBoardList?del=1&num=1">삭제</a>
											</div>
										</div>
									</td>
								</tr>
									...
									<tr class="td_style">
										...
										<td id="list_title">
											<c:if test="${!empty list.fname }">
												<a href="${ContextPath }/admin/board/reviewBoardDetail?bnum=${list.bnum}">[${list.fname}]${list.title}</a>
											</c:if>
											<c:if test="${empty list.fname }">
												<a href="${ContextPath }/admin/board/reviewBoardDetail?bnum=${list.bnum}">[공지사항]${list.title}</a>
											</c:if>
										</td>
										<td>${list.id}</td>
						...
						<a href="${ContextPath }/admin/board/reviewBoardInsert"
						...
						<form id="form" method="get"
							action="${ContextPath}/admin/board/reviewBoardSearch?">
							<table>
								<tr>
									...
									<td><input type="text" name="keyword" placeholder="검색" style="height: 35px;">
	...
	<script>
		...
		function page(idx){
			var num = idx;
			var url = "${ContextPath}/admin/board/reviewBoardList?&del=<%=request.getParameter("del")%>&num=" + num;
			location.href=url;
		}
		...
		$(document).ready(function(){
			$("#btnSearch").click(function() {
				...
				var searchurl = "${ContextPath}/admin/board/reviewBoardSearch?";
				checkit();
				if(checkSearch){
